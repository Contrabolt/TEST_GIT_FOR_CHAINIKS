...
<b>?</b> Пытаюсь создать папку <b>TEST 1</b>. А потом пробую в нее войти как вы учили <b>cd TEST 1</b>. Выходит ошибка <b>bash: cd: too many arguments</b>. Как я понимаю, стоит ограничение на длину названия папки?
