...
* На вашей главной странице GitHub отображается горизонтальное меню, меню вертикальное (вход через 3 паралельные черты в верхнем левом углу), кнопка настройки профлия под фото, Ваши активности на календаре и ниже построчно. Так же еще одно вертикальное меню имеется в верхнем правом углу (фото). Не забываем после окончания работы пользоваться пунктом <b>Sign out</b>. 
